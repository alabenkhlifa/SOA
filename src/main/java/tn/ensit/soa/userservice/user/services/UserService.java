package tn.ensit.soa.userservice.user.services;

import org.springframework.stereotype.Service;
import tn.ensit.soa.userservice.profile.entities.Profile;
import tn.ensit.soa.userservice.user.entities.User;
import tn.ensit.soa.userservice.profile.services.ProfileService;
import tn.ensit.soa.userservice.user.repositories.UserRepository;
